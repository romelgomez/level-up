((function(){
    ...
    this.RokBox.Class = new Class({
        ...
        fitscreen: function(element){
            ...
            if (isSafari6) moofx(this.containerContent.getElement('img') || this.containerContent.getElement('iframe')).style({width: 'inherit'});
            ...
            moofx(this.containerContent.getElement('img') || this.containerContent.getElement('iframe')).style({width: null, height: null});
            ...
            (function(){
                if (isSafari6 || isIE8) moofx(this.containerContent.getElement('img') || this.containerContent.getElement('iframe')).style({width: '100%'});
            }.bind(this)).delay(5);
