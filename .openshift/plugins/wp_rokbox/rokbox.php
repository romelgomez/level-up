<?php
/**
 * @version   2.50.0 January 11, 2014
...
Description: RokBox 2.50 is a fully responsive modal plug-in for WordPress and the successor of RokBox1. Rewritten from the ground up it can display many different media formats such as images, videos, music, embedded widgets, Ajax content and WordPress widgets and takes advantage of the new technologies such as HTML5 and CSS3.
...
class RokBox {
	...
	function _register_hooks() {
		 ...
		 */
		add_filter( 'the_content', array( &$this, 'backwards_compatibility' ), 9 );
		add_filter( 'widget_content', array( &$this, 'backwards_compatibility' ), 9 );

		/**
		 * RokBox content prepare
		 */
		add_filter( 'the_content', array( &$this, 'content_prepare' ) );
		add_filter( 'widget_content', array( &$this, 'content_prepare' ) );
	...
	function enqueue_mootools() {
		...
		( $options['scripts_in_footer'] == '0' ) ? $scripts_in_footer = false : $scripts_in_footer = true;
