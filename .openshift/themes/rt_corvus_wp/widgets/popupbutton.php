...
class GantryWidgetPopupButton extends GantryWidget {
    ...
    function render($args, $instance){
    	...
    	<div id="<?php echo $this->id; ?>" class="rt-popupmodule rt-block <?php echo $this->css_classname; ?> <?php echo 'rt-'.$gantry->get("blocks-default-overlay").'-block'; ?> widget">
    ...
    function _renderRokBoxLink($instance){
        ...
        if ($isRokBox2){
            ...
            $output[] = '<a href="#" class="buttontext button" rel="rokbox[' . $instance['width'] . ' ' . $instance['height'] . '][module=rt-popup]">';
        }
