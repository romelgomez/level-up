...
class GantryWidgetLoginButton extends GantryWidget {
	...
	function render($args, $instance){
		...
		<div id="<?php echo $this->id; ?>" class="rt-popuplogin rt-block <?php echo 'rt-'.$gantry->get("main-body"); ?> <?php echo $this->css_classname; ?> widget">
			...
			<?php else : ?>
				<a href="<?php echo wp_logout_url($_SERVER['REQUEST_URI']); ?>" class="buttontext button">
					<span class="desc"><?php echo $instance['logouttext']; ?></span>
				</a>
			<?php endif; ?>
			</div>
		</div>
