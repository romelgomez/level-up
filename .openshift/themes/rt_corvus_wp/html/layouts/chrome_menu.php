...
class GantryLayoutChrome_Menu extends GantryLayout {
	...
	function render($params = array()){
		...
		$variations = array( 'custom-variations', 'widget-style-variations', 'box-variations', 'title-variations', 'align-variations', 'margin-variations', 'padding-variations', 'title-style-variations', 'other-variations' );
		...
		<?php ob_start(); ?>
		<div id="<?php echo $id; ?>" class="rt-block menu-block <?php echo $widget_variations . ' ' . $classname; ?> widget">
