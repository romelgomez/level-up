<div class="footer section medium-padding bg-graphite" style="background-image: url(<?php echo get_template_directory_uri() . '/images/levelup/rog.jpg'; ?>);">
    ...
    <div class="section-inner row">
        ...
        <?php if ( is_active_sidebar( 'footer-c' ) ) : ?>
            ...
            <div class="column column-3 one-third">
                ...
                <a class="twitter-timeline" href="https://twitter.com/romelgomez07" data-widget-id="498343487540957185">Tweets por @romelgomez07</a>
...
<div class="credits section bg-dark small-padding">
    ...
    <div class="credits-inner section-inner">
        ...
        <p class="credits-right fright">
            ...
            <a class="tothetop" title="<?php _e('To the top', 'baskerville'); ?>" href="#">UP!</a>
